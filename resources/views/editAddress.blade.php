        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
               		<form id="personal-info-form" method="post" action="editAddress" enctype='multipart/form-data'>
                  		<input type="hidden" name="_token" value="{{ csrf_token() }}">
                  		 <input value="{{$address->address_id}}" name="address_id" readonly>

                  		 <div class="col-sm-12">                         
                        <div class="col-sm-4">    
                  		 <h4>Enter Street<span>*</span>:</h4>
                  		</div>
                        <div class="col-sm-4">
                        ...
                        <div class="col-sm-4">
                            	<input value="{{old('zip_code')}}" placeholder="Enter zip..." name="zip_code" type="text"></div>
                        </div>
